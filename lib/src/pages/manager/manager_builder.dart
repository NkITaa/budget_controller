                ...
                children: [
                  ManagerBuilder.costFieldBuilder(
                      ...
                      controller: TextEditingController(
                          text:
                              "${isBuggetSuggested ? (project.budgets?[0].value) : (FormatController.relevantCosts(costs: project.costs, category: Const.costTypes[0], date: DateTime.now())?.fold<double>(0, (a, b) => a + (b?.value ?? 0)) ?? 0)}${Const.currency}"),
                      overlineText: Const.costTypes[0]),
                  ManagerBuilder.costFieldBuilder(
                      enabled: false,
                      controller: TextEditingController(
                          text:
                              "${isBuggetSuggested ? (project.budgets?[1].value) : (FormatController.relevantCosts(costs: project.costs, category: Const.costTypes[1], date: DateTime.now())?.fold<double>(0, (a, b) => a + (b?.value ?? 0)) ?? 0)}${Const.currency}"),
                      overlineText: Const.costTypes[1]),
                  ManagerBuilder.costFieldBuilder(
                      enabled: false,
                      controller: TextEditingController(
                          text:
                              "${isBuggetSuggested ? (project.budgets?[2].value) : (FormatController.relevantCosts(costs: project.costs, category: Const.costTypes[2], date: DateTime.now())?.fold<double>(0, (a, b) => a + (b?.value ?? 0)) ?? 0)}${Const.currency}"),
              ...
              Row(
                children: [
                  ManagerBuilder.costFieldBuilder(
                      ...
                      controller: TextEditingController(
                          text:
                              "${isBuggetSuggested ? (project.budgets?[3].value) : (FormatController.relevantCosts(costs: project.costs, category: Const.costTypes[3], date: DateTime.now())?.fold<double>(0, (a, b) => a + (b?.value ?? 0)) ?? 0)}${Const.currency}"),
              ...
              Row(
                children: [
                  ManagerBuilder.costFieldBuilder(
                      ...
                      controller: TextEditingController(
                          text:
                              "${isBuggetSuggested ? (project.budgets?[4].value) : (FormatController.relevantCosts(costs: project.costs, category: Const.costTypes[4], date: DateTime.now())?.fold<double>(0, (a, b) => a + (b?.value ?? 0)) ?? 0)}${Const.currency}"),
                      overlineText: Const.costTypes[4]),
                  ManagerBuilder.costFieldBuilder(
                      enabled: false,
                      controller: TextEditingController(
                          text:
                              "${isBuggetSuggested ? (project.budgets?[5].value) : (FormatController.relevantCosts(costs: project.costs, category: Const.costTypes[5], date: DateTime.now())?.fold<double>(0, (a, b) => a + (b?.value ?? 0)) ?? 0)}${Const.currency}"),
